...
1. Instantiate a tokenizer and a model from the checkpoint name. Translation is usually done using an encoder-decoder
   model, such as `Bart` or `T5`.
2. Define the article that should be translatedd.
